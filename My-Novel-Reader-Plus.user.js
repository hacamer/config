...
// @name           My Novel Reader Plus Max
// @name:zh-CN     小说阅读脚本 Plus Max
// @name:zh-TW     小說閱讀腳本 Plus Max
// @version        6.4.2Plus Max
// @namespace      https://github.com/ywzhaiqi
// @author         ywzhaiqi，Hacamer
// @contributor    Hacamer，Roger Au, shyangs, JixunMoe、akiba9527 及其他网友
...
(function (Vue) {
  ...
  const sites = [
    ...
    {siteName: "泡书吧",                                               // 站点名字... (可选)
        ...
        // 获取标题
        titleReg: /^[\u4E00-\u9FA5-A-Za-z0-9_][^%&',;=?$\x22]+$.*/gim,         // 书籍标题、章节标题正则 (可选)
  ...
  // ===== 自动尝试的规则 =====
  var Rule = {
    titleRegExp: /^[\u4e00-\u9fa5--Za-z0-9_零一二三四五六七八九-（）！？@#￥%·……&*—+-=@#$%“&*）+=-\s]{0,}$/gm,
  ...
  var BookLinkMe = {
    ...
    load: function(doc) {
        ...
        var trimTitle = function(title, strict) {
            ...
            if (strict) {
                title = title.replace(/^[\u4E00-\u9FA5-A-Za-z0-9_][^%&',;=?$\x22]+$/gim, '');
            }
